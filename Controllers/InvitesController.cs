            ...
            if (model.Invite is not null && model.SelectedProjectId >= 0)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        string message = $"{ newInvite.Invitor.FullName } has invited you to collaborate on { newInvite.Project.Name }. Accept the invitation here: https://dw-bugtracker.up.railway.app/Invites/ProcessInvite/{ newInvite.CompanyToken }";
